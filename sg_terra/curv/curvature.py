...
class CurvatureAnalyzer:
    ...
    def calculate_gaussian_curvature(
        self, depth_map: np.ndarray, mask: Optional[np.ndarray] = None
    ) -> np.ndarray:
        """
...
if __name__ == "__main__":
    ...
    # 결과 출력
    critical_vals, critical_coords = analyzer.find_critical_points(
        gaussian_c, mask=mask, top_k=3
    )
