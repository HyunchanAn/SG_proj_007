...
def test_engine_recommendation_valid(mock_engine):
    ...
    recommendations = mock_engine.recommend(measured_curvature=15.0, measured_roughness=1.0)
...
def test_engine_recommendation_extreme(mock_engine):
    ...
    recommendations = mock_engine.recommend(measured_curvature=1.0, measured_roughness=1.0)
...
def test_engine_recommendation_partial(mock_engine):
    ...
    recommendations = mock_engine.recommend(measured_curvature=3.5, measured_roughness=1.0)
